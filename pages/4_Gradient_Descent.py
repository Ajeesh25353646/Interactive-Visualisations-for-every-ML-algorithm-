...
st.set_page_config(page_title="Gradient Descent Playground | Batch, SGD & Mini-Batch Visualized", page_icon="📉", layout="wide")
...
app_dir = Path(__file__).parent.parent / "apps" / "Gradient Descent"

import os
import sys
sys.path.insert(0, str(app_dir))

os.environ["ST_APP_DIR"] = str(app_dir)
