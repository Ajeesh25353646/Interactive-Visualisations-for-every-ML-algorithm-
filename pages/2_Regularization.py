...
.stSidebar .stNumberInput label { color: var(--text-primary) !important; }
.stSidebar .stNumberInput input { color: var(--text-primary) !important; background: var(--bg-card-hover) !important; }
...
app_dir = Path(__file__).parent.parent / "apps" / "Regularization"
